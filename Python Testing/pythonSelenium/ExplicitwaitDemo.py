# implicit wait - apply for every element
# explicit wait - apply for specific targeted element
# pause the test for few seconds using time class
# xpath have power to go up from child to parent class but css can not to this
import time
